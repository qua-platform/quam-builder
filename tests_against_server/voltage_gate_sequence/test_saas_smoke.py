...
def test_saas_simulate_voltage_gate_sequence(qmm, machine):
    """Verify qmm can simulate a minimal voltage-gate program on LF-FEM slot 5."""
    ...
    _, samples = simulate_program(qmm, machine, prog, simulation_duration=2000)
