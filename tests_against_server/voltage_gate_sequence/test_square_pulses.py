...
def test_square_pulses_python(qmm, machine):
    ...
    machine.gate_set.add_point("initialization", voltages={"ch1": level_init[0], "ch2": level_init[1]}, duration=duration_init)
    machine.gate_set.add_point("idle", voltages={"ch1": level_manip[0], "ch2": level_manip[1]}, duration=duration_manip)
    machine.gate_set.add_point("readout", voltages={"ch1": level_readout[0], "ch2": level_readout[1]}, duration=duration_readout)

    with qua.program() as prog:
        seq = machine.gate_set.new_sequence()
        seq.go_to_point("initialization")
        seq.go_to_point("idle")
