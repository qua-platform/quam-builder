...
def test_python_voltage_sequence_ramps(qmm, machine: QuamGateSet):
    ...
    with qua.program() as program:
        ...
        seq.ramp_to_voltages(voltages={"ch1": 0.03, "ch2": -0.03}, duration=100, ramp_duration=100)
...
def test_python_ramp_to_point_then_compensation(qmm, machine: QuamGateSet):
...
def test_track_sticky_duration_is_included_in_compensation(qmm, machine: QuamGateSet):
