...
machine.register_qubit(
    qubit_type="loss_divincenzo", quantum_dot_id="virtual_dot_1", qubit_name="Q1", xy_channel=xy_q1
)

machine.register_qubit(
    qubit_type="loss_divincenzo", quantum_dot_id="virtual_dot_2", qubit_name="Q2", xy_channel=xy_q2
)

machine.register_qubit(
    qubit_type="loss_divincenzo", quantum_dot_id="virtual_dot_3", qubit_name="Q3", xy_channel=xy_q3
)

machine.register_qubit(
    qubit_type="loss_divincenzo", quantum_dot_id="virtual_dot_4", qubit_name="Q4", xy_channel=xy_q4
)
...
machine.update_cross_compensation_submatrix(
    virtual_names=["virtual_barrier_1", "virtual_barrier_2"], channels=[p4], matrix=[[0.1, 0.5]]
)
