...
class SensorDot(QuantumDot):
    ...
    readout_resonator: ReadoutResonatorMW | ReadoutResonatorIQ | ReadoutResonatorSingle
    ...
    def _add_readout_params(
        self, quantum_dot_pair_id: str, threshold: float, projector: dict | Projector = None
    ) -> None:
    ...
    def _add_readout_projector(self, quantum_dot_pair_id: str, projector: dict | Projector) -> None:
        if isinstance(projector, Projector):
            projector = asdict(projector)
        self.readout_projectors[quantum_dot_pair_id] = projector

    def _readout_params(self, quantum_dot_pair_id: str) -> float | dict[str, float]:
        return (
