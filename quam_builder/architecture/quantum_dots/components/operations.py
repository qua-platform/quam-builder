...
@operations_registry.register_operation
def Ry(qubit: Qubit, angle: float, **kwargs):
    pass


@operations_registry.register_operation
def Rz(qubit: Qubit, angle: float, **kwargs):
    pass


@operations_registry.register_operation
def reset(qubit: QubitPair, **kwargs):
    pass


@operations_registry.register_operation
def initialize(qubit: QubitPair, **kwargs):
    pass
...
@operations_registry.register_operation
def measure(qubit: QubitPair, **kwargs):
    pass
