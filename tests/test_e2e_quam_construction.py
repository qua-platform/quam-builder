"""End-to-end tests for QUAM construction using the wiring tools.

Tests the full workflow from instrument definition → connectivity setup →
wiring allocation → QUAM construction for both superconducting qubits and
quantum dots architectures.
...
# ---------------------------------------------------------------------------
# Superconducting qubit end-to-end tests
# ---------------------------------------------------------------------------
